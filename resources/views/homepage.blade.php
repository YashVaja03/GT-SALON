...
<img class="section" src="{{asset('images/7.jpg')}}"></img>
...
<section class="services">
	...
	<!--heading---------------->
	<div class="s-heading">
	<h1><font color="white"> Services</font></h1><br><br>
	<font color="yellow"> W</font>e Provide  The Best In Class Servies For Our Customers</p>
  	</div>
	...
	<div class="bar"></div>
	<!--img---------->
	<img class="c"  alt="1" src="images/10.jpg" /><br>
	<!--servies-name---------->
	<h1>Hair Cutting </h1>
	<!--details------>
	...
	<div class="bar"></div>
	<!--img---------->
	<img class="c" alt="2" src="images/11.jpg" /><br>
	<!--servies-name---------->
	<h1>Beard Set </h1>
	<!--details------>
	...
	<div class="bar"></div>
	<!--img---------->
	<img alt="3" class="c"  src="images/8.jpg" /><br>
	<!--servies-name---------->
	<h1>Facial - Scrub </h1>
	<!--details------>
